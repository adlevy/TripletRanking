...
class TripletRankingLossLayer(object):
    ...
    def __init__(self, input_example, input_positive, input_negative, margin):
        ...
        #self.input_LossRank = input_LossRank   # IL S'AGIT D'UN POIDS DONNÉE PAR TRIPLET LORS DU CALCUL DU COUT (on peut mettre 1.0 dans un premier temps)
        self.margin = margin
...
def triplet_training(triplet_model, distance_fn,
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        distancesnegatives=[]
        """
        train_stream doit renvoyer des données qui permettent de générer des triplets (example, positif, negatif)
...
def main():
    ...
    train_set = H5PYDataset('sre04050608SWB_dataset_norm.hdf5', which_sets=('train',))
    validation_set = H5PYDataset('sre04050608SWB_dataset_norm.hdf5', which_sets=('validation',))
